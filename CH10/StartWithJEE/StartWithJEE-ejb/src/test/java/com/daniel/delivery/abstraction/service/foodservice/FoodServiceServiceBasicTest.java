...
public class FoodServiceServiceBasicTest {
    ...
    public void getById_found_ok(){
        ...
        FoodService foodService1 = new FoodService("id", "email1@email.com", "Pizzas 25", "Street 89", "imageURL", "PIZZA", 100, true, user, Collections.emptyList());
    ...
    public void deActivate_toFalse_ok(){
        ...
        FoodService foodServiceDeactivated = new FoodService("id", "email1@email.com", "Pizzas 25", "Street 89", "imageURL", "PIZZA", 100, false, userDeactivated, Collections.emptyList());
    ...
    public void getByFoodType_pizza_ok(){
        ...
        FoodService foodServicePizzaDeactivated = new FoodService("id", "email3@email.com", "Pizzas 55", "Street 79", "imageURL", "PIZZA", 100, false, userPizzaDeactivated, Collections.emptyList());
        
        User userPizza = new User("email1@email.com", "pass1");
        FoodService foodServicePizza = new FoodService("id", "email1@email.com", "Pizzas 25", "Street 89", "imageURL", "PIZZA", 100, true, userPizza, Collections.emptyList());
    ...
    public void getByFoodType_all_ok(){
        ...
        FoodService foodServiceChicken = new FoodService("id2", "email2@email.com", "Chicken 25", "Street 9", "imageURL", "CHICKEN", 100, true, userChicken, Collections.emptyList());
    ...
    public void login_deActive_empty(){
        User userPizza = new User("email1@email.com", "pass1");
        FoodService foodServicePizza = new FoodService("id", "email1@email.com", "Pizzas 25", "Street 89", "imageURL", "PIZZA", 100, false, userPizza, Collections.emptyList());
